// TODO: lua stuff in separate file
// TODO: lua render abort
// TODO: fix stl lua loading
// TODO: Object::move, rotate, flipXYZ, flipnormals? scale, implement in mesh and sphere, add lua access
// TODO: lua mesh vertex modification access somehow
...
int main(int argc, char** argv)
{
    ...
    gui.createWindow("DYBTracer", WIDTH, HEIGHT);
    ...
    while (!SDL_QuitRequested() && !quit)
    {
        ...
        if (single_rayrender_state != 2)
        {
            ...
            renderer->renderScene(scene, WIDTH, HEIGHT, gui);
            gui.present();
...
static int lua_render(lua_State* L)
{
    ...
    gui.clear();
    ray->renderScene(scene, WIDTH, HEIGHT, gui);
    gui.present();
