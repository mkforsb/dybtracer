...
logo = add_mesh()
vertex_pos(1, -1, 0); vertex_normal(0, 0, -1); vertex_texture_coords(4, 0); mesh_add_vertex(logo)
vertex_pos(-1, -1, 0); vertex_normal(0, 0, -1); vertex_texture_coords(0, 0); mesh_add_vertex(logo)
vertex_pos(-1, 1, 0); vertex_normal(0, 0, -1); vertex_texture_coords(0, 4); mesh_add_vertex(logo)
mesh_commit_triangle(logo, m1)

vertex_pos(1, -1, 0); vertex_normal(0, 0, -1); vertex_texture_coords(4, 0); mesh_add_vertex(logo)
vertex_pos(-1, 1, 0); vertex_normal(0, 0, -1); vertex_texture_coords(0, 4); mesh_add_vertex(logo)
vertex_pos(1, 1, 0); vertex_normal(0, 0, -1); vertex_texture_coords(4, 4); mesh_add_vertex(logo)
mesh_commit_triangle(logo, m1)
